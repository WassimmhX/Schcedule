    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">University Class Schedules</h1>
          <p className="text-xl text-gray-600">Browse and find your class schedules</p>
        </div>
